...
- [`EnforcedString<T, Prefix, Suffix>`](https://ts-roids.ashgw.me/types/EnforcedString.html) - Enforces a string to start with a specific prefix and end with a specific suffix.
